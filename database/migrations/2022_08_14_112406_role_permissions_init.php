...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create($tableName, function (Blueprint $table) use ($tableName) {
            ...
            if (!Schema::hasColumn($tableName, 'permission_id')) $table->unsignedBigInteger('permission_id')->index();
    ...
    public function down()
    {
        ...
        Schema::table($tableName, function (Blueprint $table) use ($tableName) {
            ...
            if (!Schema::hasColumn($tableName, 'permission_id')) $table->dropColumn('permission_id');
