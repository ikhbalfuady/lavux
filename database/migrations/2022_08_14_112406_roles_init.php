...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create($tableName, function (Blueprint $table) use ($tableName) {
            ...
            if (!Schema::hasColumn($tableName, 'role_group_id')) $table->unsignedBigInteger('role_group_id')->index()->nullable();
            if (!Schema::hasColumn($tableName, 'name')) $table->string('name');
            if (!Schema::hasColumn($tableName, 'slug')) $table->string('slug')->nullable();
    ...
    public function down()
    {
        ...
        Schema::table($tableName, function (Blueprint $table) use ($tableName) {
            ...
            if (!Schema::hasColumn($tableName, 'role_group_id')) $table->dropColumn('role_group_id');
