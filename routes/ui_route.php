...
|if you want to update this file, make sure you following the rules
|Generate the ui route in frontend by accesing url '/generator', follow the point '2' of Deploy Apps
|
*/
return [
    [
